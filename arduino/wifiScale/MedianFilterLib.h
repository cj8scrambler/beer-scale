...
#define sminof(t)   (-(((1UL<<(sizeof(t)*8UL-2))-1)*2+1)-(((~(t)0U)==(t)(-1))))
#define minof(t)    ((long) (issigned(t) ? sminof(t) : 0))
...
private:
	...
	const static T _stopper = minof(T);
...
template<typename T>
MedianFilter<T>::~MedianFilter(void)
{
	delete[] _buffer;
}
